...
library('bench')
library('ggbeeswarm')
result=bench::mark(RidgeReg(scale(longley[,2:7]),longley$GNP.deflator,lambda = 0.1),glmnet(scale(as.matrix(longley[,2:7])), longley$GNP.deflator, alpha = 0,  lambda = 0.1,thresh = 1e-100),check=FALSE)
print(result)
plot(result)
```
